...
function Nomes() {
    ...
    /*Criação de array para recebimeto dos valores*/
    var Dados = [];

    Dados[0] = document.getElementById('c1').value;
    Dados[1] = document.getElementById('c2').value;
    Dados[2] = document.getElementById('c3').value;
    Dados[3] = document.getElementById('c4').value;
    Dados[4] = document.getElementById('c5').value;
...
function novoCampo() {
    var nom = prompt("Informe a palavra");
